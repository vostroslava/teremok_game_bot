...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "🏢 Пройдите тест по методике мотивации сотрудников от Stalker Media.\n\n"
        f"📢 Если вы подписаны на наш канал @{settings.REQUIRED_CHANNEL_USERNAME}, "
        "тест будет доступен сразу.\n\n"
        "Если нет — система предложит заполнить короткую контактную форму.",
